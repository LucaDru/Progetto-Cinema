...
public class InvioEmail {
	...
	private static String msgPrenotazione="<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n"
			+ "<title>Conferma</title><style>* {box-sizing: border-box;}</style></head><div style=\"background-color: #2c031e; height: 500px; width: 500px; padding: 6%;\">\r\n"
			+ "<div style=\"background-color: white; width: 100%; height:100%; padding: 15%; padding-top: 35%;\">\r\n"
			+ "<span>La tua prenotazione &egrave; andata a buon fine.</span></br><span>Il tuo biglietto &egrave arrivata in allegato</span></br></br><span class=\"bar\"><img url='cid:qrCode'/>";
